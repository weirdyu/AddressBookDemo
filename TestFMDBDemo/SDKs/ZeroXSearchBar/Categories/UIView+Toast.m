...
NSString * const CSToastPositionMidTop          = @"midtop";
NSString * const CSToastPositionCenter          = @"center";
NSString * const CSToastPositionMidBottom       = @"midbottom";
...
- (CGPoint)centerPointForPosition:(id)point withToast:(UIView *)toast {
    if([point isKindOfClass:[NSString class]]) {
        ...
        } else if([point caseInsensitiveCompare:CSToastPositionMidTop] == NSOrderedSame) {
            return CGPointMake(self.bounds.size.width / 2, self.bounds.size.height * 0.3);
        } else if([point caseInsensitiveCompare:CSToastPositionCenter] == NSOrderedSame) {
            return CGPointMake(self.bounds.size.width / 2, self.bounds.size.height / 2);
        } else if([point caseInsensitiveCompare:CSToastPositionMidBottom] == NSOrderedSame) {
            return CGPointMake(self.bounds.size.width / 2, self.bounds.size.height * 0.7);
        }
    } else if ([point isKindOfClass:[NSNumber class]]) {
        return CGPointMake(self.bounds.size.width / 2, self.bounds.size.height * [point floatValue]);
